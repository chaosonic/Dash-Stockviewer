...
# used for testing the datatable
# table_data =[{'Stock name': 'ishare', '1D': 2.1 , '5D': 3.2 , 'M': 4.7 , '3M': 6.5, 'Y': 11.1},
...
columns.append(
    dict(name = table_header[1], id=table_header[1],
         type = 'numeric'
         )
    )   
...
# With the selectable datatable, the dropdown-menu isn't needed anymore
# still here as snippet.
# item_id = 'dropdown'
